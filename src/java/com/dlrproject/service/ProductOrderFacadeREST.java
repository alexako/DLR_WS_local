...
import com.dlrproject.ProductOrder;
 ...
 */
@Stateless
@Path("com.dlrproject.productorder")
public class ProductOrderFacadeREST extends AbstractFacade<ProductOrder> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, ProductOrder entity) {
        super.edit(entity);
    }
    ...
    public ProductOrder find(@PathParam("id") Integer id) {
